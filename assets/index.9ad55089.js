...
`}}E.id="d2e188f6a0";function F(d,{$:s,$on:v,$f7:n,$update:l,$h:u,$f7ready:o}){let e;const i=()=>{e||(e=n.toast.create({text:`
        ...
        `,position:"top",horizontalPosition:"center",closeButton:!0,closeButtonText:"Close",closeButtonColor:"red",on:{close:function(){d.router.refreshPage()}}})),e.open(),window.open("https://flekstore.com/rest/device/getUdid/"+localStorage.client_uid+"?deal_id="+localStorage.deal_id,"_self"),window.tryGetDevice=!0},t=()=>{n.request.json("https://flekstore.com/rest/device/findDeviceByFp",{fp_id:localStorage.client_uid}).then(function(c){c.data.status==="ok"&&(localStorage.device_id=c.data.data,window.tryGetDevice=!1,d.router.refreshPage())})},a=()=>{n.request.json("https://flekstore.com/rest/device/findDeviceByUdid",{udid:s("#udid-add-input").val()}).then(function(c){c.data.status==="ok"&&(localStorage.device_id=c.data.data,window.tryGetDevice=!1,d.router.refreshPage())})};return o(()=>{window.addEventListener("focus",function(){!localStorage.device_id&&window.tryGetDevice&&t()}),localStorage.device_id||t(),l()}),function(c){c.$;var m=c.$h;return c.$root,c.$f7,c.$f7route,c.$f7router,c.$theme,c.$update,c.$store,m`
  <div class="device-add">
    
    ${localStorage.dev_mode?m`
      <div class="list inset" id="udid-add-form" style="margin-top:15vh">
        <ul>
          <li class="item-content">
            ...
            <div class="item-inner" style="width: auto;">
              <label class="link" @click=${()=>a()}><i class="icon f7-icons">arrow_right_circle_fill</i></label>
            </div>
          </li>
        </ul>
      </div>
    `:m`
      <div class="block" style="margin-top:10vh">
        ...
        <!-- <a class="button button-large button-fill" @click=${()=>i()}>
          Add device
        </a> -->
        <a class="button button-large button-fill" @click=${()=>i()}>
          Add device
...
<div>
    ...
    ${e.tariff!==4?p`
      <div class="block block-pricing inset">
        ...
        <div style="display:grid;">
          <a href="/purchase/" class="button button-large button-fill">Activate</a>
        </div>
      </div>
    `:p`
      <div class="block block-pricing inset">
      ...
      ${i&&(i.method==="paypal"||i.method==="gift")?p`
      <div class="block block-pricing block-free-recovery inset">
        ...
        <div style="display:grid;">
          <a class="button button-large button-outline" @click=${()=>m()}>Restore</a>
        </div>
      </div>
      `:p`
        <center>
  ...
  <div class="block">
    <a class="button button-large button-fill button-lite" @click=${()=>a()}>
      <i class="icon f7-icons">gift</i> Enter gift code
    </a>
    <a class="button button-large button-fill button-lite copy-udid" data-clipboard-text="${d.device.udid}">
...
`}}U.id="7e26100e60";function j(d,{$:s,$on:v,$f7:n,$update:l,$h:u,$f7ready:o}){let e=!1,i=!1,t={};const a=n.toast.create({text:"UDID copied",position:"top",closeTimeout:1500,closeButton:!0}),c=()=>{n.request.json("https://flekstore.com/rest/device/getLastPayment/",{id:localStorage.device_id}).then(function(r){i=JSON.parse(r.data.data).date,l()})},m=()=>{n.request.json("https://flekstore.com/rest/device/getActivationTime/",{id:localStorage.device_id}).then(function(r){e=JSON.parse(r.data.data),l()})},k=r=>{n.request.json("https://flekstore.com/rest/device/getTariffInfo/",{tariff_id:r}).then(function(p){t=JSON.parse(p.data.data),l()})};return o(()=>{m(),c(),k(4),new ClipboardJS(".copy-udid").on("success",function(p){a.open()})}),function(r){r.$;var p=r.$h;return r.$root,r.$f7,r.$f7route,r.$f7router,r.$theme,r.$update,r.$store,p`
  <div>
    ${d.device.queue==="1"?p`
    <div class="block block-strong block-success inset">
      <center>
        ...
        <div class="tariff-description">
          The device will be activated after ${e?e+" ":p`
        ...
        <div class="block inset">
          <b class=""
            >Paid ${i?timeAgo.format(Date.parse(i.replace(/-/g,"/"))):p`
            <div class="md in-text-preloader">
              <div class="preloader color-white">
                <span class="preloader-inner">
                  <svg viewBox="0 0 36 36">
    ...
    <div class="block block-strong block-success inset">
      <center>
        ...
        <div class="block inset">
          <b class=""
            >Requested ${i?timeAgo.format(Date.parse(i.replace(/-/g,"/"))):p`
            <div class="md in-text-preloader">
              <div class="preloader color-white">
                <span class="preloader-inner">
                  <svg viewBox="0 0 36 36">
    ...
    <div class="block">
      <a
        ...
        data-clipboard-text="${d.device.udid}"
      >
        <i class="icon f7-icons">square_on_square</i> Copy UDID
      </a>
      <center>
...
`}}j.id="017339df1e";function N(d,{$:s,$on:v,$f7:n,$update:l,$h:u,$f7ready:o}){let e=!1;e=new Date(d.device.date.replace(/-/g,"/")),e=e.setFullYear(e.getFullYear()+1);const i=n.toast.create({text:"UDID copied",position:"top",horizontalPosition:"center",closeTimeout:1500,closeButton:!0}),t=()=>{n.dialog.create({title:"Link to download",text:`
        Copy the link and download the certificate to your computer. <br>Do not forget to read the guide before downloading!
        <div class="dialog-input-field input"><input type="text" class="dialog-input" value="https://sign.flekstore.com/getCert?id=${d.device.stream}" /></div>
      `,buttons:[{text:"Guide",onClick:function(){d.router.navigate("/article/1/")}},{text:"Close"}],verticalButtons:!0}).open()};return o(()=>{new ClipboardJS(".copy-udid").on("success",function(c){i.open()})}),function(a){a.$;var c=a.$h;return a.$root,a.$f7,a.$f7route,a.$f7router,a.$theme,a.$update,a.$store,c`
...
<div>
  <div class="block block-strong block-success inset">
    <center>
      ...
      <div class="block inset">
        <b class="">Activation expires ${axisDateFormat.format(e)}</b>
      </div>
    </center>
  </div>
  ...
  <div class="list inset dev-cert-download">
    <ul>
      <li>
        <a class="item-link item-content" @click=${()=>t()}>
          <div class="item-media">
            <img src="https://flekstore.com/client/img/CertificateImage.png" width="60px"/>
        </div>
          <div class="item-inner">
...
`}}N.id="9cc2193fd9";function L(d,{$:s,$on:v,$f7:n,$update:l,$h:u,$f7ready:o,$f7router:e}){let i=!1,t=[];const a=()=>{n.request.json("https://flekstore.com/rest/device/getGifts",{id:localStorage.device_id}).then(function(r){t=JSON.parse(r.data.data),l()})},c=()=>{n.request.json("https://flekstore.com/rest/device/getDevice",{id:localStorage.device_id}).then(function(r){i=JSON.parse(r.data.data),l()})},m=()=>{localStorage.removeItem("device_id"),k()},k=()=>{e.refreshPage()};return o(()=>{localStorage.device_id!==void 0&&(c(),a()),n.toast.close()}),function(r){r.$;var p=r.$h;r.$root,r.$f7,r.$f7route;var C=r.$f7router;return r.$theme,r.$update,r.$store,p`
  <div class="page" data-name="device">
    ...
    <div class="page-content ptr-content" @ptr:refresh=${k}>
      <div class="ptr-preloader">
        <div class="preloader"></div>
        <div class="ptr-arrow"></div>
      </div>
              ...
              <ul>
                <li>
                  <div class="item-content">
                    <div class="item-media">
                      <img src="https://flekstore.com/client/img/device/devices/${i.type+""+i.product}.png" />
                    </div>
                    <div class="item-inner">
                      <div class="item-title-row">
                        <div class="item-title">${i.type}</div>
                        ${localStorage.dev_mode?p`
                        <div class="item-after">
                          <a class="link color-red" @click=${()=>m()}>
                      ...
                      <div class="item-footer">${i.udid}</div>
                      <div class="item-subtitle">
